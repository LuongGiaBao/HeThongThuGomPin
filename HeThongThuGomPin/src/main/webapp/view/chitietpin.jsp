    ...
    <form action="PinServlet" method="get">
        ...
        <div class="row">
            ...
            <div class="col-6">
              ...
              <c:if test ="${sessionScope.acc == null}">
                         	<li>
                            <a href="DongHoServlet?command=TAIKHOANCHITIET"><span class="btn btn-danger" style="display: inline-block; width: 300px; margin-top: 10px; cursor: pointer;" onclick="addToCart()">Đăng nhập để đặt lịch xử lý pin</span></a>
							</li>
                        </c:if>
